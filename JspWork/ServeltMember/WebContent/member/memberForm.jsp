...
<h2>회원 가입</h2>
	'*' 표시 항목은 필수 입력 항목입니다.
<form action ="memInsert.go" id="frm" method="post">
<input type="hidden" name="uid" id="uid">
		<table>
			...
			<tr>
				<td>아이디</td>
				<td><input type="text" name="userid" id="userid" size="20" disabled>* 
			...
			<tr>
				<td><input type="button" value="로그인" onclick="location.href='loginForm.jsp'"></td>
