...
<body>
	<div class="container mt-5">
		...
		<div class="card my-5">
			<form action="/Pension_Project/boardWrite.go" method="post" id="frm">
				<input type="hidden" id="content" name="content"> <input
					type="hidden" id="btype" name="btype" value="${btype }"> <input
					type="hidden" id="userid" name="userid" value="${sessPm.userid }">
				<div class="card-body">
